...
- dirty hack in interrupt handler routine had to be implemented (check below) due to wide pulse.
...
For manual on setting PR1 adjustment for your utility-meter, check the [Sensor adjusting](http://) section.
...
![schematics of sensor based on LM393 comparator, integrator and inverter with scope connection points at DOut integrator](https://raw.githubusercontent.com/malipek/esp8266_utility_meter_mon/master/aassets/LM393_integrator_inverter_scope.png)
